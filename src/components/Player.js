...
const Player = ({name = "FIFA player", team = "Club Side", nationality = "Country", age = "Football age", jerseyNumber = "30", imageUrl = '/images/cr7.jpg'}) => {
    return (
        <>
            ...
            <Card className="card">
                <div className="card-internal-container">
                    <div className="card-image-container">
                        <Card.Img src={imageUrl} alt="Player image"/>
                    </div>
                    <Card.Body>
